...
## 「AI for TuGraph」小样本条件下的自然语言至图查询语言翻译大模型微调 <sup style="color:red">[new]<sup>  
...
## 「TuGraph for AI」RAG在智能问答场景中的落地 <sup style="color:red">[new]<sup>  
...
## 基于运营商文本数据的知识库检索 <sup style="color:red">[new]<sup>  
...
## 基于TPU平台的OCR模型性能优化 <sup style="color:red">[new]<sup>  
...
## 基于Intel Gaudi AI加速器的大语言模型微调与推理优化 <sup style="color:red">[new]<sup>  
